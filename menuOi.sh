...
while :; do
clear && echo -e $tit
  echo -e "\e[01;37;41m              MENU OI              \e[0m"; sleep .4; echo
    ...
    case $verifica in # case MENU
       ...
       1) while :; do
           ...
           grepi1=$(echo $response | grep -c "Not eligible")
                 case $grepi1 in
                      1) echo -e "\e[01;33m Token bom! Mas o chip nao esta elegivel nele\e[0m / \e[01;33m$mssg\e[0m"|pv -qL 25; echo; break;;
                      *)
                 esac
           ...
           grepi3=$(echo $response | grep -c "Invalid Campaign")
                 case $grepi3 in
                      1) echo -e "\e[01;33m Token retornou invalido! Tente outro\e[0m / \e[01;33m$mssg\e[0m"|pv -qL 25; echo; break;;
                      *)
                 esac
           ...
           grepi5=$(echo $response | grep -c "7x1 elegibility")
                 case $grepi5 in
                      1) echo -e "\e[01;32m Esta tendo atualização no servidor netmodz\e[0m / \e[01;37mCONTAGEM: $i\e[0m"|pv -qL 25;;
                      *)
                 esac
              done
           done
